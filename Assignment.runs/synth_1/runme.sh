...
HD_PWD='P:/ENEL373/labs/Week3Lab3Project2/Week3Lab3Project2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_top_level.vds -m64 -mode batch -messageDb vivado.pb -notrace -source counter_top_level.tcl

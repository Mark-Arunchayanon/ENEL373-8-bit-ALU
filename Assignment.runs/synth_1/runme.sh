...
HD_PWD='P:/Courses/ENCE373/Assignment/Lab_A01_group_15/Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_design.vds -m64 -mode batch -messageDb vivado.pb -notrace -source alu_design.tcl

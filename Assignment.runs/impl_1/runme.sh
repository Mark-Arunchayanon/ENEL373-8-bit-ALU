...
HD_PWD='P:/Courses/ENCE373/Assignment/Lab_A01_group_15/Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_design.vdi -applog -m64 -messageDb vivado.pb -mode batch -source alu_design.tcl -notrace
